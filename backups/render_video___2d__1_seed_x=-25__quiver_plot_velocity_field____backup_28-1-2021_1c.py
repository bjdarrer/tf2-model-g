...
def nucleation_and_motion_in_G_gradient_fluid_2D(writer, args, R=50): # was R=30 BJD 4.1.2021
    ...
    def source_G(t):
        ...
        #) * center + triangle * gradient # BJD - note minus sign maybe in wrong w.r.t. (u*u - 1) --- 22.12.2020
            #np.exp(-0.5*((x-25)**2 + (y-15)**2)) + np.exp(-0.5*((x+40)**2 + (y+15)**2))
...
#-------------------------BJD 28.1.2021----rough code at present----------------------------------------- 
            ...
            U = np.loadtxt("/home/brendan/software/tf2-model-g/arrays/quiver_array18/u.txt") #, delimiter=" :-) ", usecols=(120))  # (426, 240)
            V = np.loadtxt("/home/brendan/software/tf2-model-g/arrays/quiver_array18/v.txt") #, delimiter=" :-) ", usecols=(120))  # (426, 240)
            ...
            """
            fig, hf = plt.subplots(figsize=(10,10))
            hf.set_title("pivot='mid'; every 10th arrow; units='inches'" + str(c1))
            ...
            plt.savefig('/home/brendan/software/tf2-model-g/plots/2D_video24/2D_video_velocity_' + str(c1) + '.png')
...
def save1():
    ...
    os.system("ffmpeg -r 1 -i /home/brendan/software/tf2-model-g/plots/2D_video24/2D_video_velocity_%01d.png -vcodec mpeg4 -y nucleation_and_motion_in_fluid_2D___velocity_vector___2d____video_85.mp4")
